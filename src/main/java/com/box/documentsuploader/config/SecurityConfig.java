...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_RESOURCES = {"/swagger-ui/**","/.well-known/**, ", "/v3/api-docs/**"};
    private static final String[] USER_RESOURCES = {"/api/documents/**"};
    private static final String[] ADMIN_RESOURCES = {"/api/user/**", "/api/documents/**"};
    private static final String LOGIN_RESOURCE = "/login";

    private static final String APPLICATION_OWNER = "BOX_CHALLENGER";
